...
const { createCategoriaConvenioSchema, updateCategoriaConvenioSchema } = require("../validations/categoriaConvenioSchema")
...
class CategoriaConvenioRepository {
    ...
    setupRoutes() {
        ...
        this.router.post("/", auth, isAdmin, validateRequest(createCategoriaConvenioSchema), categoriaConvenioController.create)
        this.router.put("/:id", auth, isAdmin, validateRequest(updateCategoriaConvenioSchema), categoriaConvenioController.update)
